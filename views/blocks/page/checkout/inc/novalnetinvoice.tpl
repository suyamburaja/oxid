        ...
        [{if $oView->getFraudModuleStatus($sPaymentID) }]
            [{if $oView->getNovalnetConfig('iCallbacknovalnetinvoice') == 1}]
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" size="20" name="dynvalue[pinbycall_novalnetinvoice]" autocomplete="off" value="[{$oxcmp_user->oxuser__oxfon->value}]" >
                    </div>
                </div>
            [{elseif $oView->getNovalnetConfig('iCallbacknovalnetinvoice') == 2}]
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" size="20" name="dynvalue[pinbysms_novalnetinvoice]" autocomplete="off" value="[{$oxcmp_user->oxuser__oxmobfon->value}]" >
                    </div>
                </div>
            [{/if}]
        [{/if}]
